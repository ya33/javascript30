...
const sort1 = inventors.sort(function(a,b) {
...
const sort2 = inventors.sort( function(a,b) {
...
const boulevards = Array.from(document.querySelectorAll('.mw-category-group a'));
const boulevardsDE = boulevards
                            .map((boulevard) => `${boulevard.textContent}`)
                            .filter((boulevard) => boulevard.includes('de'));
console.log(boulevardsDE);
// 7. sort Exercise
// Sort the people alphabetically by last name
const sort3 = people.sort(function(a, b) {
